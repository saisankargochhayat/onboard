...
window.Modernizr = function (g, d, q) {
    ...
    function j(a, b, c) {
        var f = a.charAt(0).toUpperCase() + a.slice(1), d = (a + " " + J.join(f + " ") + f).split(" ");
        if (n(b, "string") || n(b, "undefined"))return I(d, b);
        d = (a + " " + K.join(f + " ") + f).split(" ");
        a:{
            var a = d, e;
            for (e in a)if (f = b[a[e]], f !== q) {
                if (!1 === c) {
                    b = a[e];
                    break a
                }
    ...
    var e =
    {}, m = d.documentElement, h = d.createElement("modernizr"), i = h.style, h = d.createElement("input"), L = {}.toString, v = " -webkit- -moz- -o- -ms- ".split(" "), J = ["Webkit", "Moz", "O", "ms"], K = ["webkit", "moz", "o", "ms"], c = {}, r = {}, p = {}, x = [], y = x.slice, k, s = function (a, b, c, f) {
        var e, h, g = d.createElement("div"), j = d.body, i = j || d.createElement("body");
        if (parseInt(c, 10))for (; c--;)e = d.createElement("div"), e.id = f ? f[c] : "modernizr" + (c + 1), g.appendChild(e);
    ...
    z = function (a, b) {
        var b = b || d.createElement(Q[a] || "div"), a = "on" + a, c = a in b;
    ...
    Function.prototype.bind || (Function.prototype.bind = function (a) {
        ...
        var c = y.call(arguments, 1), f = function () {
            if (this instanceof f) {
                var d = function () {
                };
                d.prototype = b.prototype;
                var d = new d, e = b.apply(d, c.concat(y.call(arguments)));
    ...
    c.fontface = function () {
        ...
        s('@font-face {font-family:"font";src:url("https://")}', function (b, c) {
            var f = d.getElementById("smodernizr"), f = (f = f.sheet || f.styleSheet) ?
    ...
    e.addTest = function (a, b) {
        if ("object" == typeof a)for (var c in a)B(a, c) && e.addTest(c, a[c]); else {
            a = a.toLowerCase();
            if (e[a] !== q)return e;
    ...
    var h = h = null, M = function () {
        ...
        return a
    }, r = this.html5 || {}, S = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, R = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, E, O = "_html5shiv", C = 0, N = {}, t;
    try {
